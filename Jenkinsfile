...
pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE_NAME = 'pravin2012/qbshop-app'
        DOCKER_MIGRATION_IMAGE_NAME = 'pravin2012/qbshop-migration'
    ...
    stages {
        ...
        stage('Clone Repository') {
            steps {
                script {
                    clone("https://github.com/pravinyadav20/Qualibytes-Ecommerce.git", "dev")
                }
            }
        }
